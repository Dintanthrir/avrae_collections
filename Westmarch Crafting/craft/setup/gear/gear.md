...
__*Example*__
> `!craft setup gear -type armor -name "chain shirt" -tool "smith"`
Prepare to craft a _Chain Shirt_ (requires that your active character is proficient with _Smith's Tools_).
